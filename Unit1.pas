...
//Заводим массив изображения звёзд, заводим массив типа звёзд
//Заводим массив координат звёзд по Х и по Y 
...
i,j,x,y: integer;
begin
//Перемешиваем звёзды случайным образом
i:=Random(400);
x:=Random(Xmax);
ImgStars[i].Left:=x;
j:=Random(400);
...
begin
//Выгружаем масссив типов звёзд
For i:=0 to 1 Do
   begin
   BitMapStars[i].Free;
   end;
//Выгружаем массив звёзд
For i:=0 to 400 Do
   begin
   ImgStars[i].Free;
   end;
